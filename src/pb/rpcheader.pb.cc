...
constexpr RpcResponseHeader::RpcResponseHeader(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : type_(0)

  , data_size_(0u){}
struct RpcResponseHeaderDefaultTypeInternal {
  constexpr RpcResponseHeaderDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT RpcResponseHeaderDefaultTypeInternal _RpcResponseHeader_default_instance_;
}  // namespace faster
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_rpcheader_2eproto[2];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_rpcheader_2eproto[1];
...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::faster::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::faster::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::faster::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::faster::RpcHeader, args_size_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::faster::RpcResponseHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::faster::RpcResponseHeader, type_),
  PROTOBUF_FIELD_OFFSET(::faster::RpcResponseHeader, data_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::faster::RpcHeader)},
  { 9, -1, -1, sizeof(::faster::RpcResponseHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::faster::_RpcHeader_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::faster::_RpcResponseHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\006faster\"I\n\tRpcHeader\022\024"
  "\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001("
  "\014\022\021\n\targs_size\030\003 \001(\r\"x\n\021RpcResponseHeade"
  "r\022,\n\004type\030\001 \001(\0162\036.faster.RpcResponseHead"
  "er.Type\022\021\n\tdata_size\030\003 \001(\r\"\"\n\004Type\022\014\n\010RE"
  "SPONSE\020\000\022\014\n\010PUSHMSGS\020\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, 230, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 
...
constexpr RpcResponseHeader_Type RpcResponseHeader::RESPONSE;
constexpr RpcResponseHeader_Type RpcResponseHeader::PUSHMSGS;
constexpr RpcResponseHeader_Type RpcResponseHeader::Type_MIN;
constexpr RpcResponseHeader_Type RpcResponseHeader::Type_MAX;
constexpr int RpcResponseHeader::Type_ARRAYSIZE;
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:faster.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:faster.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:faster.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:faster.RpcHeader)
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:faster.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:faster.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:faster.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:faster.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:faster.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
RpcResponseHeader::RpcResponseHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:faster.RpcResponseHeader)
}
RpcResponseHeader::RpcResponseHeader(const RpcResponseHeader& from)
  ...
  ::memcpy(&type_, &from.type_,
    ...
    reinterpret_cast<char*>(&type_)) + sizeof(data_size_));
  // @@protoc_insertion_point(copy_constructor:faster.RpcResponseHeader)
}
...
RpcResponseHeader::~RpcResponseHeader() {
  // @@protoc_insertion_point(destructor:faster.RpcResponseHeader)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void RpcResponseHeader::ArenaDtor(void* object) {
  RpcResponseHeader* _this = reinterpret_cast< RpcResponseHeader* >(object);
  (void)_this;
}
void RpcResponseHeader::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:faster.RpcResponseHeader)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* RpcResponseHeader::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::faster::RpcResponseHeader_Type>(val));
        } else
          goto handle_unusual;
        continue;
      // uint32 data_size = 3;
...
uint8_t* RpcResponseHeader::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:faster.RpcResponseHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_data_size() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_data_size(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:faster.RpcResponseHeader)
  return target;
}

size_t RpcResponseHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:faster.RpcResponseHeader)
  size_t total_size = 0;
...
void RpcResponseHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<RpcResponseHeader *>(to)->MergeFrom(
      static_cast<const RpcResponseHeader &>(from));
}


void RpcResponseHeader::MergeFrom(const RpcResponseHeader& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:faster.RpcResponseHeader)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:faster.RpcResponseHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RpcResponseHeader::InternalSwap(RpcResponseHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RpcResponseHeader, data_size_)
      + sizeof(RpcResponseHeader::data_size_)
      - PROTOBUF_FIELD_OFFSET(RpcResponseHeader, type_)>(
...
template<> PROTOBUF_NOINLINE ::faster::RpcHeader* Arena::CreateMaybeMessage< ::faster::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::faster::RpcHeader >(arena);
}
template<> PROTOBUF_NOINLINE ::faster::RpcResponseHeader* Arena::CreateMaybeMessage< ::faster::RpcResponseHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::faster::RpcResponseHeader >(arena);
}
